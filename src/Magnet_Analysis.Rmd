...
knitr::opts_chunk$set(echo = TRUE, message=FALSE, fig.width=4, fig.height=4, fig.path='/Users/chadgevans/Research/Projects/Chicago_Magnet_Analysis/graphs/')
```
